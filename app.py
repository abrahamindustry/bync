...
connection = pymysql.connect(host='localhost', user='root', password='Alwin1234!')
    ...
    if choice == 'Normal User':
        ...
        if st.button('Login'):
            if ad_user == 'admin' and ad_password == '123':
                ...
                fig = px.pie(df, values=values, names=labels, title="Pie-Chart for User' Experienced Level")
                st.plotly_chart(fig)
